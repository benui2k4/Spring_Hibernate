					...
					<div class="col-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								...
								<form:form class="forms-sample" action="updateProduct"
									modelAttribute="p" method="post" enctype="multipart/form-data">

									<div class="form-group">
										<label for="productId">Product Id</label>
										<form:input type="text" readonly="true" path="productId"
											class="form-control" />
									</div>
									<div>
									...
									<label>Image</label>
									<div class="form-group">
										<span class="input-group-append"> <input type="file"
											name="imageUrl" /> <form:hidden path="proImg" />
										</span>
									</div>
									<td></td>
									<td><img style="width: 40px; height: 40px;"
										src="<c:url value="resources"/>/Img/${p.proImg}" /><br /></td>
									<br />
									<td><input type="submit" class="btn btn-primary mr-2"
										value="Update" /><input type="reset" class="btn btn-light"
										value="Clear" /></td>
								</form:form>
							</div>
						</div>
