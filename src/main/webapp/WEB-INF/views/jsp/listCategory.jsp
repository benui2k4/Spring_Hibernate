				...
				<ul class="navbar-nav mr-lg-2">
					<li class="nav-item nav-search d-none d-lg-block">
						<div class="input-group">
							...
							<form action="searchCategoryByName">
								<input type="text" name="categoryName" class="form-control"
									id="navbar-search-input" aria-label="search"
									aria-describedby="search" placeholder="Search Category Name...">
							</form>
						</div>
				...
				<div class="content-wrapper">
					<div class="card-body">
						...
						<div class="btn-group" role="group" aria-label="Basic example">
							<form action="initInsertCategory">
						...
						<div class="table-responsive pt-3">
							<table class="table table-bordered">
								...
								<tr style="text-align: center;">
									<th>Category Id (Mã Danh Mục)</th>
									<th>Category Name (Tên Danh Mục)</th>
									<th>Status (Trạng Thái Hàng Hóa)</th>
									<th>Details</th>
									<th>Delete (Xóa)</th>
								</tr>
								<c:forEach items="${listCate}" var="c">
									<tr style="text-align: center;">
										...
										<td>
											<form action="detailCategory" method="GET">
										...
										<td>
											<form id="deleteForm_${c.categoryId}" action="deleteCategory"
												method="GET">
												<input type="hidden" name="categoryId"
													value="${c.categoryId}">
												<button type="button" class="btn btn-danger"
													onclick="confirmDelete('${c.categoryId}', '${c.categoryName}')">Delete</button>
											</form>
										</td>
							...
							<div class="pagination">
								<c:forEach items="${listPage}" var="pageNumber">
									<a href="listCategory?page=${pageNumber}"
