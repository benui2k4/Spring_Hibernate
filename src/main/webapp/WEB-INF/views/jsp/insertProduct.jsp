			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="col-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								<h1 class="card-title">Insert Product</h1>

								<form:form class="forms-sample" action="insertProduct"
									...
									<div class="form-group">
										...
										<form:input path="producer" type="text" class="form-control"
											id="producer" placeholder="Producer" />
									...
									<div class="form-group">
										<label for="manufactureDate">Manufacture</label>
										<form:input path="manufactureDate" type="date"
											class="form-control" id="manufactureDate" />
										<form:errors path="manufactureDate" cssClass="text-danger" />
									...
									<div class="form-group">
										<label for="cate.categoryName">Category</label>
										<form:select class="form-control" id="cate.categoryId"
											path="cate.categoryId">
											<option value="">-- Select Category Name --</option>
											<form:options items="${listCate}" itemLabel="categoryName"
												itemValue="categoryId" />
										</form:select>
										<br />
										<form:errors path="cate.categoryName" cssClass="text-danger" />
									</div>
									<div class="form-group">
										<label>Images</label> <span class="input-group-append">
