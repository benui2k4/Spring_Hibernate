			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="col-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								<h1 class="card-title">Detail Product (Thông Tin Chi Tiết)</h1>
								<table class="table table-bordered">
									<tr>
										<td>Id (Mã Sản Phẩm) :</td>
										<td>${p.productId}</td>
									</tr>
									<tr>
										<td>Name ( Tên Sản Phẩm ):</td>
										<td>${p.productName}</td>
									</tr>
									<tr>
										<td>Producer (Nhà Phân Phối ) :</td>
										<td>${p.producer}</td>
									</tr>
									<tr>
										<td>Status ( Trạng Thái Sản Phẩm ):</td>
										<td>${p.status?"Còn Hàng":"Hết Hàng"}</td>
									</tr>
									<tr>
										<td>ManufactureDate ( Ngày Nhập ) :</td>
										<td><fmt:formatDate value="${p.manufactureDate}"
												pattern="dd/MM/yyyy" /></td>
									</tr>
									<tr>
										<td>ExpirationDate ( Ngày Hết Hạn ):</td>
										<td><fmt:formatDate value="${p.expirationDate}"
												pattern="dd/MM/yyyy" /></td>
									</tr>
									<tr>
										<td>Price ( Giá Sản Phẩm ):</td>
										<td><fmt:formatNumber value="${p.price}" type="currency"></fmt:formatNumber>
										</td>
									</tr>
									<tr>
										<td>Category Id ( Mã Danh Mục ):</td>
										<td>${p.cate.categoryId}</td>
									</tr>
									<tr>
										<td>Category Name ( Tên Danh Mục ):</td>
										<td>${p.cate.categoryName}</td>
									</tr>

									<tr>
										<td>Image ( Ảnh Minh Họa ) :</td>
							...
							<br /> <a href="preUpdateProduct?productId=${p.productId}"
								class="btn btn-success">Update (Cập Nhật)</a><br /> <a
								href="listProduct" class="btn btn-primary">Back (Quay Lại)</a>
						</div>
					</div>
				</div>
				<footer class="footer">
